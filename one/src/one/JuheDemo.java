...
public class JuheDemo {
	...
	public static void getRequest2() {
		...
		Map params = new HashMap();// 请求参数
		params.put("mobile", "13168089115");// 接收短信的手机号码
		params.put("tpl_id", "56298");// 短信模板ID，请参考个人中心短信模板设置
		params.put("tpl_value", "%23code%23%3d431515");// 变量名和变量值对。如果你的变量名或者变量值中带有#&=中的任意一个特殊符号，请先分别进行urlencode编码后再传递，<a
